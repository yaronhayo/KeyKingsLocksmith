const FROM_EMAIL = "noreply@keykingslocksmithsc.com";
const TO_EMAIL = "keykingslocksmithsc@gmail.com";
class ResendEmailService {
  ...
  async sendBookingNotification(data, submissionId) {
  ...
  async sendContactNotification(data, submissionId) {
  ...
  generateBookingEmail(data, submissionId) {
    const urgencyBadge = data.urgency === "asap" ? '<span style="background: #dc2626; color: white; padding: 4px 12px; border-radius: 4px; font-weight: bold;">🚨 EMERGENCY</span>' : `<span style="background: #f3f4f6; color: #374151; padding: 4px 12px; border-radius: 4px;">${data.urgency.toUpperCase()}</span>`;
    return `
<!DOCTYPE html>
<html>
<head>
  ...
  <div style="background: #f9fafb; padding: 20px; border: 1px solid #e5e7eb;">
    <div style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
      ...
      <div style="margin-top: 20px; padding: 15px; background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 4px;">
        ...
        <strong>Received:</strong> ${(/* @__PURE__ */ new Date()).toLocaleString()}
      </div>
    </div>
...
4105 Liberty Highway Unit B, Anderson, SC 29621
  ...
  generateContactEmail(data, submissionId) {
    return `
<!DOCTYPE html>
<html>
<head>
...
${data.message}
  ...
  generateContactConfirmationEmail(data) {
    return `
<!DOCTYPE html>
<html>
<head>
...
const RecaptchaConfig = {
  ...
  newsletter: {
    action: "newsletter",
    scoreThreshold: 0.3
    // Lower threshold for newsletter (less critical)
  }
};

export { RecaptchaConfig as R, emailService as e, getClientIP as g, verifyRecaptcha as v };
